...
class CustomerHyperlink(serializers.HyperlinkedRelatedField):
    view_name = 'api:authentication:user_order_detail'
...
class CustomUserSerializer(serializers.HyperlinkedModelSerializer):
    url = serializers.HyperlinkedIdentityField(view_name='api:authentication:user_detail', lookup_field='pk')
...
class UserOrderDetailSerializer(serializers.HyperlinkedModelSerializer):
    ...
    url = serializers.HyperlinkedIdentityField(view_name='api:order:order_detail', lookup_field='pk')
